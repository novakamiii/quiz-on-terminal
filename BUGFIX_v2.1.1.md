# Bug Fix - show_message() Error - v2.1.1
...
After the countdown timer update in v2.1.0, 2 instances of `self.ui.show_message()` without arguments were reintroduced in the code. These were being used to add blank lines for spacing.
...
### 2. Line 162 - display_all_questions()
**Before:**
```python
else:
...
# quiz_game.py:162:                self.ui.show_message()
```
...
**Version 2.1.1** - Fixed show_message() error reintroduced in v2.1.0
